...
const dropdownValues = [
  ...
  },
  {
    ...
    <ol type="i" style="margin-left: 15px; margin-right: 15px;">
      ...
      <li style="margin-left: 16px; margin-right: 15px;">GUI – Web version: Incluir todo mundo. MASSA Algorithm web interface, Belo Horizonte, 2025. https://... (accessed 2025-01-01).</li>
      <li style="margin-left: 17px; margin-right: 15px;">CLI – Local version: Veríssimo, G. C. MASSA Algorithm: version 0.9.5, UFMG: Belo Horizonte, 2024. <a href="https://github.com/gcverissimo/MASSA_Algorithm" target="_blank">GitHub</a> (accessed 2025-01-01).</li>
    </ol>`
  }
];
